...
public class DateTimeExample 
{
	public static void main(String args[])
	{
		...
		System.out.println("Suntraction of days : "+localDate.minusDays(5));
		System.out.println("Suntraction of months : "+localDate.minusMonths(15));
		System.out.println("Suntraction of weeks : "+localDate.minusWeeks(45));
		System.out.println("Suntraction of Years : "+localDate.minusYears(5));
		...
		{
			System.out.println("localDate2 comes after localdates3");
		}
		
		//ifBefore() example
		if(localDate3.isBefore(localDate))
		{
			System.out.println("localDate3 comes before localdates1");
		}
	}
}
